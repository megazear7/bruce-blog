  ...
  <html lang="en">
    ...
    <body>
      <div class="header-container">
        ${desktopImage ? html`<img class="desktop" alt="Orison smoking pipe icon" src="${desktopImage}">` : ''}
        ${mobileImage ? html`<img class="mobile" alt="Orison smoking pipe icon" src="${mobileImage}">` : ''}
